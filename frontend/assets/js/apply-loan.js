...
async function fetchLoans() {
  ...
  grid.innerHTML = `
    <div style="grid-column:1/-1;text-align:center;padding:60px;color:var(--text2)">
      <i class="fas fa-spinner fa-spin" style="font-size:28px"></i><br><br>
      Loading loan offers…
    </div>`;
  ...
  if (!loans || loans.length === 0) {
    grid.innerHTML = `
      <div style="grid-column:1/-1;text-align:center;padding:60px 20px;border:1px dashed var(--border);border-radius:12px">
        <i class="fas fa-search" style="font-size:40px;color:var(--text3);display:inline-block;margin-bottom:12px"></i>
    ...
    <div class="loan-card">
      <div class="loan-card-header">
        <div class="loan-card-bank-avatar" style="overflow:hidden">
          <img src="${logoSrc}" alt="${loan.bank_name}" class="bank-logo-img" style="width:100%;height:100%;object-fit:contain;display:block" onerror="this.src='../assets/images/banks/default.png'">
        </div>
